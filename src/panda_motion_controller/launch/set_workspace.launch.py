...
def generate_launch_description():
    ...
    workspace_setup = Node( #comment if you see uncommented
        package='panda_motion_controller',
        executable='set_workspace',
        parameters=[
            robot_description,
...
def generate_launch_description():
    ...
    return LaunchDescription([trajectory_selector])
'''